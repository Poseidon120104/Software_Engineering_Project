...
export const SkillsInfo = [
  ...
  // {
  //   id: 0,
  //   img: "", // Add logo if available
  //   role: "Fullstack Developer",
  //   company: "Tech Company",
  //   date: "Date Range",
  //   desc: "Worked on developing and maintaining fullstack web applications using modern frameworks and tools. Collaborated with teams to design efficient system architectures, build responsive UIs, and develop RESTful APIs while ensuring scalability and performance optimization.",
  //   skills: [
  //     "HTML",
  //     "CSS",
  //     "JavaScript",
  ...
  //   date: "Date Range",
  //   desc: "Contributed to both frontend and backend development across multiple projects. Designed and implemented interactive interfaces, optimized database queries, and collaborated closely with stakeholders to deliver high-quality, maintainable solutions.",
  //   skills: [
  //     "ReactJS",
  //     "Redux",
  //     "JavaScript",
  ...
  //   date: "Date Range",
  //   desc: "Assisted in developing responsive and user-friendly web interfaces. Translated design mockups and wireframes into functional components, ensuring cross-browser compatibility and adherence to accessibility standards.",
  //   skills: [
  //     "HTML",
  //     "CSS",
  //     "JavaScript",
